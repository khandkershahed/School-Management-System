    ...
    public function run()
    {
        ...
        if(!$teacherusersexists)
        {
            $teachers = [
                ...
                [
                    'name' => 'Khandker Shahed Teacher',
                    'email' => 'shahed@teacher.com',
                    'password' => Hash::make('123456789@#'),
                ],
                [
        ...
        if(!$teacherusersexists)
        {
            $Parents = [
                ...
                [
                    'name' => 'Khandker Shahed Parent',
                    'email' => 'shahed@parent.com',
                    'password' => Hash::make('123456789@#'),
                ],
                [
        ...
        if(!$studentusersexists)
        {
            $students = [
                ...
                [
                    'name' => 'Khandker Shahed Student',
                    'email' => 'shahed@student.com',
                    'password' => Hash::make('123456789@#'),
                ],
                [
