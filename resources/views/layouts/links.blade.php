...
<link rel="stylesheet" href="{{ asset('assets/fonts/shahed/shahed.ttf') }}">
<link rel="stylesheet" href="{{ asset('assets/css/shahed-icons.css') }}">
...
@endswitch
<style>
    /* Only when sidebar is opened on tablet/mobile */
