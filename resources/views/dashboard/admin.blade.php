...
<div class="w-full px-6 py-6 mx-auto">
    ...
    <div class="flex flex-wrap -mx-3">
        ...
        <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4 ">
            <div
                class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border group hover:shadow-xl ">
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-semibold leading-normal text-sm">{{ trans('main.users-numbers') }}
                                </p>
                                <h5 class="mb-0 font-bold">
                                    {{ $users_number }}
                                    <span
                                        class="leading-normal text-sm font-weight-bolder {{ $new_users_percentage < 0 ? 'text-red-500' : 'text-lime-500' }} ">
                                        {{ $new_users_percentage }}%</span>
                                </h5>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
                            <div
                                class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-gray-800 to-gray-500 hover:bg-gradient-to-tl group-hover:from-purple-700 group-hover:to-pink-500">
                                <i
                                    class="fa-sharp fa-solid fa-users leading-none text-lg relative top-3.5 text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-semibold leading-normal text-sm">
                                    {{ trans('main.students-numbers') }}</p>
                                <h5 class="mb-0 font-bold">
                                    {{ $students_number }}
                                    <span
                                        class="leading-normal text-sm font-weight-bolder  {{ $new_students_percentage < 0 ? 'text-red-500' : 'text-lime-500' }}">{{ $new_students_percentage }}%</span>
                                </h5>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
                            <div
                                class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-gray-800 to-gray-500 hover:bg-gradient-to-tl group-hover:from-purple-700 group-hover:to-pink-500">
                                <i
                                    class="fa-solid fa-chalkboard-user fa-sharp leading-none text-lg relative top-3.5 text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-semibold leading-normal text-sm">
                                    {{ trans('main.teachers-numbers') }}</p>
                                <h5 class="mb-0 font-bold">
                                    {{ $teachers_number }}
                                    <span
                                        class="leading-normal text-lime-500 text-sm font-weight-bolder  {{ $new_teachers_percentage < 0 ? 'text-red-500' : 'text-lime-500' }}">{{ $new_teachers_percentage }}%</span>
                                </h5>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
                            <div
                                class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-gray-800 to-gray-500 hover:bg-gradient-to-tl group-hover:from-purple-700 group-hover:to-pink-500">
                                <i
                                    class="fa-solid fa-person-chalkboard leading-none text-lg relative top-3.5 text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-semibold leading-normal text-sm">
                                    {{ trans('main.classrooms-numbers') }}</p>
                                <h5 class="mb-0 font-bold">
                                    {{ $classroom_number }}
                                </h5>
                            </div>
                        ...
                        <div class="px-3 text-right basis-1/3">
                            <div
                                class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-gray-800 to-gray-500 hover:bg-gradient-to-tl group-hover:from-purple-700 group-hover:to-pink-500">
                                <i
                                    class="fa-solid fa-school fa-sharp leading-none text-lg relative top-3.5 text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div
        class="bg-white  w-full h-80 shadow-xl mt-8 rounded-2xl flex justify-center items-center overflow-hidden relative">
        ...
        <div
            class="absolute top-50 {{ App::getlocale() == 'ar' ? 'right-0' : 'left-0' }} text-white text-lg px-12  max-w-6xl">
            <h1 class="text-2xl font-semibold text-white py-2">
                {{ trans('main.welcome-dash', ['name' => auth()->user()->name]) }}</h1>
    ...
    <div class="grid grid-cols-8">
        <div class="col-span-2 mt-10">
                ...
                <div class="w-full max-w-full px-3  lg:flex-none">
                    <div
                        ...
                        <div class="relative h-full overflow-hidden bg-cover rounded-xl"
                            ...
                            <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                                <h5 class="pt-2 mb-2 font-bold text-white">
                                    {{ \Illuminate\Support\Str::limit($last_post->title, 65, '...') }}</h5>
                                <div class="flex mb-2">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <a class="mt-auto mb-0 font-semibold leading-normal text-white group text-sm "
                                        href="{{ route('post.show', $last_post->id) }}">
                                        <i
                                            class="fas {{ App::getLocale() == 'ar' ? 'fa-arrow-left' : 'fa-arrow-right' }} ease-bounce text-sm group-hover:translate-x-1.25 mx-1 leading-normal transition-all duration-200"></i>
            ...
            @empty
                <div class="w-full max-w-full px-3  lg:flex-none">
                    <div class="bg-white p-8 shadow-xl mt-8 rounded-2xl m-auto">

                        <p class="text-gray-900">{{ trans('No Posts available right now') }}</p>
                    </div>
                </div>
            @endforelse
        </div>
