               ...
               <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                   <li class="leading-normal text-sm">
                       <a class="opacity-50 text-slate-700"
                           href="javascript:;">{{ trans('main-sidebar.' . Route::currentRouteName()) }}</a>
                   </li>
                   <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']"
                       aria-current="page">LTR</li>
               </ol>
          ...
          <div class="hs:hidden lg:flex relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease-soft">
            ...
            <a href="javascript:;" class="block p-0 transition-all ease-nav-brand text-sm text-slate-500"
               ...
               <li class="flex items-center pr-4 xl:inline-block" id="sidebaricononlys">
                   <a href="javascript:;" sidenav-trigger
            ...
            <a class="btn btn-primary" target="_blank">Search</a>
               ...
               <li class="relative flex items-center pl-2 px-4">
                   ...
                   <a id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification" href="javascript:;"
                       class="block p-0 transition-all text-sm ease-nav-brand text-slate-500" aria-expanded="false">
                       <div class="relative">
                           <i class="cursor-pointer fa fa-bell fa-xl" aria-hidden="true"></i>
                           <div
                               class="absolute inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full
               ...
               <div>
                           ...
                           @if ($loop->iteration <= 4)
                               <div class="divide-y max-w-sm  divide-gray-100 dark:divide-gray-700">
                                   <form method="post" action="{{ route('notificationNewComment.remove') }}">
                                       @method('delete')
                                       @csrf
                                       <input type="hidden" value="{{ $notification->data['post_id'] }}"
                                           name="post_id">
                                       <input type="hidden" value="{{ $notification->id }}" name="notification_id">
                                       <button href="{{ route('post.show', $notification->data['post_id']) }}"
                                           class="flex w-full px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                                           <div class="flex-shrink-0">
                                               <img class="rounded-full w-11 h-11" src="{{ $user->profile_photo_url }}"
                                                   alt="{{ $notification->data['comment_author_name'] }} image">
                                               <div
                                           ...
                                           <div class="flex flex-col justify-center items-start ">
                                               <div
                                                   class="text-sm block font-semibold text-gray-900 dark:text-white px-2">
                                                   {{ $notification->data['comment_author_name'] }}
                                               </div>
                                               <h6
                                                   class="mb-1 font-normal leading-normal text-sm truncate break-words max-w-xs px-2">
                   ...
                   <div class="flex mx-2 pt-3">
                       ...
                       <button id="states-button" data-dropdown-toggle="dropdown-states"
                           class="btn btn-dark flex-shrink-0 z-10 inline-flex items-center py-1 px-1 text-sm font-medium text-center  border border-gray-300 rounded-l-lg text-black dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600"
                           type="button">
                           @if (LaravelLocalization::getCurrentLocale() == 'ar')
                               {{-- علم مصر --}}
                               <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                   width="40" zoomAndPan="magnify" viewBox="0 0 30 30.000001" height="40"
